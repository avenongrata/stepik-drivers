...
static ssize_t sol_read(struct file *filp, char __user *buf, size_t count, loff_t *pos)
{
	char *tbuf = NULL;
...
static long sol_unlocked_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{	
	long tmp_num;
	char *buf = NULL;
