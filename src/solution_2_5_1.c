...
static ssize_t sol_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
...
static ssize_t sol_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
	return -EAGAIN;
}
